...
public class FastestCP extends WorkflowPolicy {
	boolean backCheck = true;

	public FastestCP(WorkflowGraph g, ResourceSet rs, long bw) {
		super(g, rs, bw);
	...
	private result assignParents(WorkflowNode curNode) {
		...
		Instance inst=new Instance(1, resources.getMaxResource());
